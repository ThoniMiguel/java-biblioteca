 ...
 * @author thoni
 */
public class TelaIncluirPublisher extends javax.swing.JFrame {

    /**
     * Creates new form TelaIncluirPublisher
     */
    public TelaIncluirPublisher() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextFieldNomeEditora.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        ...
        jTextFieldUrl.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        ...
        jPanelIncluirAutorLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelIncluirAutorLayout.createSequentialGroup()
                ...
                .addGroup(jPanelIncluirAutorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextFieldUrl, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel1.setText("INCLUIR EDITORA");
    ...
    private void jButtonSalvarAutorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarAutorActionPerformed
        ...
        String name = jTextFieldNomeEditora.getText();
        String url = jTextFieldUrl.getText();
        boolean situacao = pubC.insert(name, url);
        if(situacao){
            JOptionPane.showMessageDialog(null, "Os valores foram inseridos com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaIncluirPublisher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
